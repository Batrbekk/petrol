...
export default async function Contact({ params: { lang } }: { params: { lang: string } }) {
  ...
  return (
    <main className="container mx-auto px-4 lg:px-0">
      <section className="flex flex-col lg:flex-row items-stretch mt-14">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1332.8354929728966!2d65.50001692669476!3d44.82794299095893!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x41f7fe755750e985%3A0x461cd30f75036cf9!2z0JDQniDQotGD0YDQs9Cw0Lkg0J_QtdGC0YDQvtC70LXRg9C8!5e0!3m2!1sru!2skz!4v1726714717577!5m2!1sru!2skz" height="450" className="w-full lg:w-1/2 rounded-t-lg lg:rounded-none" loading="lazy" />
        <div className="w-full lg:w-1/2 bg-[#FF5722] flex flex-col pl-4 py-8 lg:py-0 lg:pl-32 justify-center text-white rounded-b-lg lg:rounded-none">
